...
select salary*12 as "Anual Salary", name "InstructName" from instructors; -- derived column(salary*12) if we want to name salary*12 table write aas newname called as alisas
describe instructors; 
-- want to see deptID from table;
select deptid from instructors;
-- if we dont want duplicate record as we are getting in deptid
select distinct deptid,name from instructors;
-- using from to where
select *  from students;
select* from students where deptid=5;
select* from students where gender="Female";
select* from students where deptid<5;
select* from students where deptid=5 and gender="female";
select* from students where deptid=5 or gender="female";

select* from instructors;
select* from instructors where salary<=80000;
select name,salary from instructors  where salary>=80000 and  salary<=85000;
select name,salary from instructors  where not (salary>=80000 and  salary<=85000);
-- if we dealing with range we can also use between
select name,salary from instructors  where salary between 80000 and 85000;
select* from instructors where deptid=1 or deptid=2 or deptid=3 or deptid=4; 
select name, salary*12 as asal from instructors where asal*12<1200000; -- we cant use column alysis in where bcz where runs first then select
-- if want to see multiple instruct working in various dept
select* from instructors where deptid in(1,2,3,4);
select* from instructors where deptid not in(1,2,3,4);
select* from instructors where deptid in(1,2,3,4) and (salary between 80000 and 85000);
select* from students;
select* from students where name="Oliver Miller";
select *from students where name like "O%"; -- if we want to get first character is O
select* from students where name like "%n"; -- if we wnat last character of any name
select* from students where name like "%a_"; -- if we want 2nd last character or 3rd last double underscore
select* from students where name like "%\_%"; -- if we want name list having underscore b/w name
select* from students where name like "%\%%"; -- shows percentage sign between name 