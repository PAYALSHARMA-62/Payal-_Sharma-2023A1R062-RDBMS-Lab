...
select e.first_name,d.department_name from employees e right outer join departments d on(e.department_id=d.department_id) union select e.first_name,d.department_name from employees e left outer join departments d on(e.department_id=d.department_id);
;
-- if i want full name
select concat(e.first_name," ",e.last_name) fullname,d.department_name from employees e right outer join departments d on(e.department_id=d.department_id) union select concat(e.first_name," ",e.last_name)fullname,d.department_name from employees e left outer join departments d on(e.department_id=d.department_id);
create view deptsalreport as -- issa brr br is query ko nhi bnana pdaga
select department_name,max(salary) as maxsal,min(salary) as minsal,avg(salary) as avgsal,sum(salary) as sumsal,count(*) as nooemp from employees e join departments d on(e.department_id=d.Department_id) group by department_name;
select* from deptsalreport;